    ...
    return (
        <div className="container py-12 md:py-24 space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <h1 className="text-4xl md:text-5xl font-bold font-heading">
                        Revolucionando el Mercado de <span className="text-primary-light">Autopartes</span> en Colombia
                    </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center border-y py-12">
                ...
                <div>
                    <div className="text-4xl font-bold text-primary-light mb-2">+50k</div>
                    <div className="text-muted-foreground">Repuestos Disponibles</div>
                </div>
                <div>
                    <div className="text-4xl font-bold text-primary-light mb-2">24h</div>
            ...
            <div className="max-w-3xl mx-auto text-center space-y-6">
                <h2 className="text-3xl font-bold font-heading">Nuestra Misión</h2>
