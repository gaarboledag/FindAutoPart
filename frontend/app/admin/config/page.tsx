...
import {
    ...
    Edit, Trash2, LogOut, Loader2, CheckCircle
} from 'lucide-react'
                ...
                <main className="container mx-auto px-4 py-8">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <h1 className="text-4xl font-bold font-heading text-primary-light">
                                        ...
                                        <table className="w-full">
                                            ...
                                            <tbody>
                                                {cotizaciones.map((cotiz) => (
                                                    <tr key={cotiz.id} className="border-b border-white/5 hover:bg-white/5">
                                ...
                                <CardContent>
                                    <div className="overflow-x-auto">
                                        <table className="w-full">
                                            ...
                                            <tbody>
                                                {ofertas.map((oferta) => (
                                                    <tr key={oferta.id} className="border-b border-white/5 hover:bg-white/5">
